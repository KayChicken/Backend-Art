...
class TasksController {
  ...
  async createTask(req, res) {
    try {
      ...
      const newTask = await db.query(`INSERT INTO tasks_quiz_teachers (task_question, task_answers, task_correct_answer, task_correct_desc) VALUES (${task_question}, ARRAY ${task_answers}, ${task_correct_answer}, ${task_correct_desc}`);
